    ...
    render() {
        return this.state.assessmentGroups===undefined?'':[
            <Breadcrumb key="breadcrumb" className="mx-auto mt-2">
                ...
                <Breadcrumb.Item onClick={() => this.props.history.push({ pathname: '/rubric-results', state: { rubric: this.state.rubric } })}>Results of {this.state.rubric.name}</Breadcrumb.Item>
